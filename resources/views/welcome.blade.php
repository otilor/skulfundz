        ...
        <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/illustrations/landing.svg)">
            ...
            <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                ...
                <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                    <!--begin::Title-->
                    <h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">Manage your children's school fundz.
                        <br />
                    ...
                    <!--end::Title-->
                    <!--begin::Action-->
                    <a href="#" class="btn btn-primary w-20 py-5">Try SkulFundz</a>
                    <!--end::Action-->
                </div>
                <!--end::Heading-->
                <!--begin::Clients-->
                ...
                <div class="col-md-4 px-5">
                    ...
                    <div class="text-center mb-10 mb-md-0">
                        ...
                        <div class="d-flex flex-center mb-5">
                            ...
                            <!--end::Badge-->
                            <!--begin::Title-->
                            <div class="fs-5 fs-lg-3 fw-bolder text-dark">Start managing their school fundz.</div>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Description-->
            ...
            <div class="container">
                ...
                <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                    ...
                    <div class="d-flex align-items-center order-2 order-md-1">
                        ...
                        <!--end::Logo image-->
                        <!--begin::Logo image-->
                        <span class="mx-5 fs-6 fw-bold text-gray-600 pt-1" href="/">© {{ now()->get('year') }}  Fundz Inc.</span>
                        <!--end::Logo image-->
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Menu-->
